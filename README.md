...
Current sources: the CrowdStrike 2026 Threat Hunting Report for observed attacker tradecraft, the SANS 2026 Security Awareness and Culture Report for practitioner staffing benchmarks, CybSafe's Oh, Behave! 2025-2026 for workforce behavior, the Fable Security AI Behavior Index for measured AI behavior broken out by role, the Harmonic Security AI Usage Index for observed AI tool usage, the Verizon 2026 DBIR for breach-corpus evidence on the human element and shadow AI, the IBM Cost of a Data Breach Report 2026 for breach-cost benchmarking, and the CISA Insider Threat Mitigation Guide for federal program guidance on reporting culture and training content.
